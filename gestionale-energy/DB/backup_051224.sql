...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pb_wb` (
  `id_pb` int unsigned NOT NULL COMMENT 'Id della balla generata dal pressista',
  `id_wb` int unsigned NOT NULL COMMENT 'Id della balla generata dal carrellista',
  `id_implant` int unsigned NOT NULL COMMENT 'Id dell''impianto',
...
INSERT INTO `pb_wb` VALUES (40,3,1),(41,4,1),(42,5,2),(43,6,1),(44,7,1),(45,8,2),(46,9,1),(47,10,2),(48,11,2),(49,12,2),(50,13,1),(51,14,2),(52,15,1),(53,16,1),(54,17,2),(55,18,1);
...
-- Dump completed on 2024-12-05  8:38:33
